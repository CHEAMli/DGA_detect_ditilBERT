...
class BertCharacterEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None, position_ids=None):
        ...
        if position_embeddings.shape != words_embeddings.shape:
            # 尝试调整position_embeddings的形状以匹配words_embeddings
            position_embeddings = position_embeddings.expand_as(words_embeddings)

        if token_type_embeddings.shape != words_embeddings.shape:
            token_type_embeddings = token_type_embeddings.expand_as(words_embeddings)
